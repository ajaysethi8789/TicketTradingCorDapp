...
@InitiatingFlow
@StartableByRPC
class TransferFestivalTicketFlow(
    ...
    override fun call(): SignedTransaction {
        ...
        val tokenPointer = original.state.data.token.tokenType as TokenPointer<FestivalTicketState>
        val reportId = tokenPointer.pointer.pointer

        val ticketRef = getStateReference(serviceHub, FestivalTicketState::class.java, reportId)
        ...
        val tx = serviceHub.validatedTransactions.getTransaction(ticketRef.ref.txhash)!!
    ...
    @Suppress("unused")
    @InitiatedBy(TransferFestivalTicketFlow::class)
    class TransferFestivalTicketFlowResponse (private val flowSession: FlowSession): FlowLogic<Unit>() {
        @Suspendable
        override fun call() {
