...
@InitiatingFlow
@StartableByRPC
class RedeemFestivalTicketFlow(
    ...
    override fun call(): SignedTransaction {
        ...
        if (dealer.host == ourIdentity){
            return RedeemFestivalTicketFlowWithinNode().call()
        }
    ...
    @Suppress("unused")
    @InitiatedBy(RedeemFestivalTicketFlow::class)
    class RedeemFestivalTicketFlowResponse (private val flowSession: FlowSession): FlowLogic<Unit>() {
        @Suspendable
        override fun call() {
     ...
     */
    inner class RedeemFestivalTicketFlowWithinNode {
        @Suspendable
