...
import com.r3.ticket.tokens.flows.PurchaseFestivalTicketFlow
...
class PurchaseDiamond : Command {
    ...
    override fun execute(main: Main, array: List<String>, parameters: String): Iterator<String> {
        ...
        service.startTrackedFlow(::PurchaseFestivalTicketFlow, linearId, dealer, buyer, amount).returnValue.get()
