...
import com.r3.ticket.tokens.flows.TransferFestivalTicketFlow
...
class TransferDiamond : Command {
    ...
    override fun execute(main: Main, array: List<String>, parameters: String): Iterator<String> {
        ...
        service.startTrackedFlow(::TransferFestivalTicketFlow, tokenId, seller, buyer, amount).returnValue.get()
